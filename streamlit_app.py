...
# 페이지 설정
st.set_page_config(page_title="BlastTap 5.7", layout="centered")
st.title("🔥 BlastTap 5.7: 최종 AI조업판 (실전 통합판)")
...
st.header("📊 BlastTap 5.7 AI조업 결과")
...
st.download_button("📥 CSV 다운로드", data=csv, file_name="조업리포트_5_7.csv", mime='text/csv')
